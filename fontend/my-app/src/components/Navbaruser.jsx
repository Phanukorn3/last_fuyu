      ...
      <nav className="bg-white shadow-md px-6 py-8 flex items-end justify-between">
        ...
        <ul className="flex gap-10 absolute left-1/2 transform -translate-x-1/2 -translate-y-0">
          <li className="relative group">
            <button className="text-gray-800 hover:text-orange-500 border-b-2 border-transparent font-medium hover:border-orange-500 transition duration-200">
              อาหารสำหรับสุนัข
            </button>
            <div className="absolute left-1/2 -translate-x-1/2 top-full hidden text-gray-400 group-hover:block bg-white shadow-md rounded-b-md w-55 h-50">
              ...
              <ul className="py-2 px-8 mt-5">
                <li className="px-2 py-2 hover:text-orange-500 border-b-2 border-transparent hover:underline cursor-pointer">
                    <Link to="">
                  อาหารลูกสุนัข</Link>
                </li>
                <li className="px-2 py-2 hover:text-orange-500 border-b-2 border-transparent hover:underline cursor-pointer">
          ...
          <input
            ...
            className="border border-gray-300 rounded-l-md px-3 py-1 focus:outline-none focus:ring-1 focus:ring-orange-400"
          />
          <button className="bg-orange-500 text-white px-3 py-1 rounded-r-md hover:bg-orange-600 transition">
            ค้นหา
          </button>
        </div>
      </nav>
